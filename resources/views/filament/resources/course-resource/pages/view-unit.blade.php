                            ...
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <div class="flex-shrink-0 flex gap-2">
                                    ...
                                    <a href="{{ CourseResource::getUrl('edit', ['record' => $record->id]) }}" 
                                       class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                                       title="Edit Course">
